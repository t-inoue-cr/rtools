...
- **Docling文章変換** — PDF / Word / Excel / PowerPoint / HTML / Markdown / OpenDocument / RTF / EPUB / CSV などを 1 つ選び、`docling` の `DocumentConverter` だけで Markdown にします。自前のレイアウト処理は使いません。スキャン画像のみの PDF や画像 OCR、音声は対象外です。
